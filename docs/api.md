...
- `options` <[Object]>  Set of configurable options to set on the browser. Can have the following fields:
  ...
  - `prefs` <[Object]> Additional browser preferences. The list of Chromium preferences can be found [here](https://src.chromium.org/viewvc/chrome/trunk/src/chrome/common/pref_names.cc?view=markup). Can't be used in headless mode or with `userDataDir` option/argument.
